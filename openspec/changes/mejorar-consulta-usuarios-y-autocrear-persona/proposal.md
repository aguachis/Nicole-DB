...
- Afecta SP `database/procedures/auth/P_User_List.sql`.
- Afecta SP `database/procedures/auth/P_User_Create.sql`.
- Puede afectar documentos de integracion de auth/usuarios en `database/docs/db/integrations/`.
