...
- `tables/`, `tables/indexes/`, `types/`, `procedures/`, `seeds/` y `database/`: scripts de definición y creación.
- `docs/db/BACKEND_DATABASE_CONTEXT.md`: índice técnico del modelo vigente para integraciones.
- `docs/db/02-conventions.md`: convenciones de diseño.
- `docs/db/03-new-database-working-document.md`: decisiones y bitácora técnica.
- `docs/db/entities/`, `docs/db/stored-procedures/` y `docs/db/integrations/`: documentación por objeto e integración.
