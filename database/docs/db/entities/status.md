...
- C#: `database/docs/db/entities/status/EntityStatus.cs`
- TypeScript: `database/docs/db/entities/status/entity-status.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/status/00-current-schema.sql`
- Script normalizado para repo: `database/tables/00-create-table-entitystatus.sql`
