...
- C#: `database/docs/db/entities/person/Person.cs`
- TypeScript: `database/docs/db/entities/person/person.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/person/00-current-schema.sql`
- Script normalizado para repo: `database/tables/03-create-table-person.sql`
