...
- C#: `database/docs/db/entities/user-company/UserCompany.cs`
- TypeScript: `database/docs/db/entities/user-company/user-company.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/user-company/00-current-schema.sql`
- Script normalizado para repo: `database/tables/11-create-table-user-company.sql`
