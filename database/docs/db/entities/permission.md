...
- C#: `database/docs/db/entities/permission/Permission.cs`
- TypeScript: `database/docs/db/entities/permission/permission.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/permission/00-current-schema.sql`
- Script normalizado para repo: `database/tables/09-create-table-permission.sql`
