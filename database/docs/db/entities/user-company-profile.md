...
- C#: `database/docs/db/entities/user-company-profile/UserCompanyProfile.cs`
- TypeScript: `database/docs/db/entities/user-company-profile/user-company-profile.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/user-company-profile/00-current-schema.sql`
- Script normalizado para repo: `database/tables/12-create-table-user-company-profile.sql`
