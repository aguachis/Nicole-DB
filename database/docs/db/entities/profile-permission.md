...
- C#: `database/docs/db/entities/profile-permission/ProfilePermission.cs`
- TypeScript: `database/docs/db/entities/profile-permission/profile-permission.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/profile-permission/00-current-schema.sql`
- Script normalizado para repo: `database/tables/10-create-table-profile-permission.sql`
