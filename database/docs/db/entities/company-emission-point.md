...
- C#: `database/docs/db/entities/company-emission-point/CompanyEmissionPoint.cs`
- TypeScript: `database/docs/db/entities/company-emission-point/company-emission-point.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/company-emission-point/00-current-schema.sql`
- Script normalizado para repo: `database/tables/06-create-table-company-emission-point.sql`
