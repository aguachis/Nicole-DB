...
- C#: `database/docs/db/entities/company/Company.cs`
- TypeScript: `database/docs/db/entities/company/company.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/company/00-current-schema.sql`
- Script normalizado para repo: `database/tables/04-create-table-company.sql`
