...
- C#: `database/docs/db/entities/company-branch/CompanyBranch.cs`
- TypeScript: `database/docs/db/entities/company-branch/company-branch.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/company-branch/00-current-schema.sql`
- Script normalizado para repo: `database/tables/05-create-table-company-branch.sql`
