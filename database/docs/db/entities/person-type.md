...
- C#: `database/docs/db/entities/person-type/PersonType.cs`
- TypeScript: `database/docs/db/entities/person-type/person-type.ts`

## Scripts

- Esquema actual recibido desde BD: `database/docs/db/entities/person-type/00-current-schema.sql`
- Script normalizado para repo: `database/tables/02-create-table-person-type.sql`
