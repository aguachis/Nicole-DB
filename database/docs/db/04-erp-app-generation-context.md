...
- `database/tables/00-create-table-entitystatus.sql`
- `database/tables/01-create-table-identification-type.sql`
- `database/tables/02-create-table-person-type.sql`
